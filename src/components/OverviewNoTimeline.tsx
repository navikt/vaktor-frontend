        ...
        <Table>
            <Table.Header>
                <Table.Row>
                    ...
                    <Table.HeaderCell scope="col">Vakttelefon.</Table.HeaderCell>
            ...
            <Table.Body>
                {props.groups.map(({ name, phone, slack, id, description, type }, i) => {
                    return (
                        <Table.Row key={i + id}>
                            <Table.DataCell>{name}</Table.DataCell>
                            <Table.DataCell>{phone}</Table.DataCell>
                            <Table.DataCell>{slack === '' ? 'Ikke oppgitt' : slack}</Table.DataCell>
